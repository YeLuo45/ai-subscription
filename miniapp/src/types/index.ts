// Types for AI Subscription Aggregator - MiniApp
...
export const DEFAULT_MODELS: Omit<AIModel, 'id' | 'createdAt'>[] = [
  { name: 'MiniMax M2', provider: 'minimax', apiBaseUrl: 'https://api.minimax.chat/v1', apiKey: '', modelName: 'MiniMax-Text-01', temperature: 0.3, maxTokens: 1000, isDefault: true },
